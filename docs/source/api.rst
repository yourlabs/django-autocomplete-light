...
Everything should be available with ``import autocomplete_light``, see in
``autocomplete_light/__init__.py``:

.. literalinclude:: ../../autocomplete_light/__init__.py
...
.. autoclass:: autocomplete_light.views.RegistryView
   :members:
