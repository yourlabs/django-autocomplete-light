    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_inline', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inline_test_models', to='select2_generic_foreign_key.TestModel')),
            ],
        ),
    ]
