...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_select2__ = __webpack_require__(330);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__autocomplete_init__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__forward__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dal_select2_npm_select2_js__ = __webpack_require__(333);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(63);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.fn.getFormPrefix = function () {
     ...
     */
    var parts = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name').split('-');
    var prefix = '';
    ...
    for (var i in parts) {
        ...
        var result = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(':input[name^=' + testPrefix + ']');
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.fn.getFormPrefixes = function () {
    /*
     ...
     */
    var parts = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name').split('-').slice(0, -1);
    var prefixes = [];
...
function initialize(element) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(element).trigger('autocompleteLightInitialize');
    initialized.push(element);
}
window.__dal__initialize = initialize;

__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-autocomplete-light-function=select2]:not([id*="__prefix__"])').each(initialize);
});

__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).bind('DOMNodeInserted', function (e) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.target).find('[data-autocomplete-light-function=select2]:not([id*="__prefix__"])').each(initialize);
});
...
function getCookie(name) {
    ...
    if (document.cookie && document.cookie != '') {
        ...
        for (var i = 0; i < cookies.length; i++) {
            var cookie = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.trim(cookies[i]);
...
if (document.csrftoken === null) {
    ...
    var $csrf = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('form :input[name="csrfmiddlewaretoken"]');
    if ($csrf.length > 0) {
...
function getForwardStrategy(element) {
    var checkForCheckboxes = function () {
        var all = true;
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(element, function (ix, e) {
            if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(e).attr("type") !== "checkbox") {
                all = false;
            }
        });
        return all;
    ...
    if (element.length === 1 && element.attr("type") === "checkbox" && element.attr("value") === undefined) {
        // Single checkbox without 'value' attribute
        // Boolean field
        return "exists";
    } else if (element.length === 1 && element.attr("multiple") !== undefined) {
...
function getFieldRelativeTo(element, name) {
    var prefixes = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(element).getFormPrefixes();

    for (var i = 0; i < prefixes.length; i++) {
        var fieldSelector = "[name=" + prefixes[i] + name + "]";
        var field = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(fieldSelector);
...
function getValueFromField(field) {
    ...
    var serializedField = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(field).serializeArray();
    ...
    var getValueOf = function (elem) {
        // Return elem.value
        // or null if something went wrong
        if (elem.hasOwnProperty("value") && elem.value !== undefined) {
            return elem.value;
        } else {
            return null;
        }
...
function getForwards(element) {
    var forwardElem, forwardList, forwardedData, divSelector, form;
    divSelector = "div.dal-forward-conf#dal-forward-conf-for-" + element.attr("id");
    form = element.length > 0 ? __WEBPACK_IMPORTED_MODULE_0_jquery___default()(element[0].form) : __WEBPACK_IMPORTED_MODULE_0_jquery___default()();
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(forwardList, function (ix, field) {
        var srcName, dstName;
        if (field.type === "const") {
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on('autocompleteLightInitialize', '[data-autocomplete-light-function=select2]', function () {
    var element = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);

    // Templating helper
    function template(text, is_html) {
        if (is_html) {
            var $result = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<span>');
            $result.html(text);
            return $result;
        } else {
            return text;
    ...
    function result_template(item) {
        return template(item.text, element.attr('data-html') !== undefined || element.attr('data-result-html') !== undefined);
    }

    function selected_template(item) {
        if (item.selected_text !== undefined) {
            return template(item.selected_text, element.attr('data-html') !== undefined || element.attr('data-selected-html') !== undefined);
        } else {
    ...
    var ajax = null;
    if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('data-autocomplete-light-url')) {
        ajax = {
            url: __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('data-autocomplete-light-url'),
            dataType: 'json',
            delay: 250,
            ...
            processResults: function (data, page) {
                if (element.attr('data-tags')) {
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(data.results, function (index, value) {
                        value.id = value.text;
                    });
                }
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).select2({
        tokenSeparators: element.attr('data-tags') ? [','] : null,
        debug: true,
        placeholder: '',
        language: element.attr('data-autocomplete-light-language'),
        minimumInputLength: 0,
        allowClear: !__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).is('[required]'),
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).on('select2:selecting', function (e) {
        ...
        var select = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
            ...
            data: {
                text: data.id,
                forward: getForwards(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this))
            },
            beforeSend: function (xhr, settings) {
                xhr.setRequestHeader("X-CSRFToken", document.csrftoken);
            },
            success: function (data, textStatus, jqXHR) {
                select.append(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('<option>', { value: data.id, text: data.text, selected: true }));
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-autocomplete-light-function=select2]:not([id*="__prefix__"])').each(function () {
    window.__dal__initialize(this);
});

/***/ })
/******/ ]);
//# sourceMappingURL=dal_select2.js.map